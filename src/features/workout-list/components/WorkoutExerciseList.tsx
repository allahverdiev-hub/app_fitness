...
import {
  ...
  reorderExercises,
} from "@/features/workout-list/utils/reorderExercises";
...
export function WorkoutExerciseList({
  ...
  const {
    ...
    commitReorder: reorderExercises,
  });
      ...
      >
        ...
        <ul className={`${styles.list} ${editing ? styles.listEditing : ""}`}>
          {exercises.map((exercise, index) => {
            const isDeleting =
              dissolvingId === exercise.id || collapsingId === exercise.id;
            ...
            return (
              <DeleteAnimatedListItem
                ...
                onCollapseComplete={() => onCollapseComplete?.(exercise.id)}
              >
                <div
